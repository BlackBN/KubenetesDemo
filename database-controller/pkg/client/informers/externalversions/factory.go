...
type SharedInformerFactory interface {
	...
	Coolops() databasemanager.Interface
}

func (f *sharedInformerFactory) Coolops() databasemanager.Interface {
	return databasemanager.New(f, f.namespace, f.tweakListOptions)
}
